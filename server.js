...
app.get('/api/test_message', function(req, res) {
    var apikey = process.env.apikey//"I-vh0iOsv423UQKIu9HTAm7cJu8vO52s2_-oCHVfEmEc";
    ...
    request.post( options, ( error, response, body ) => {
        ...
        const mlInstanceId = process.env.ml_instance_id//'41a5e5d0-8f9d-4960-a04d-3e5882764e20';
